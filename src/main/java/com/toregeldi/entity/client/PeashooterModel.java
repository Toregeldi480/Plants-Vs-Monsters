...
public class PeashooterModel extends EntityModel<PeashooterEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData cube_r7 = leaf_1.addChild("cube_r7", ModelPartBuilder.create().uv(24, 35).cuboid(-2.0F, -1.0F, -1.0F, 3.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 1.0F, 0.0F, 1.0472F, 0.3054F));
		...
		ModelPartData cube_r10 = leaf_2.addChild("cube_r10", ModelPartBuilder.create().uv(0, 37).cuboid(-2.0F, -1.0F, -1.0F, 3.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 1.0F, 0.0F, 1.0472F, 0.3054F));
		...
		ModelPartData cube_r13 = leaf_3.addChild("cube_r13", ModelPartBuilder.create().uv(36, 39).cuboid(-2.0F, -1.0F, -1.0F, 3.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 1.0F, 0.0F, 1.0472F, 0.3054F));
		...
		ModelPartData cube_r16 = leaf_4.addChild("cube_r16", ModelPartBuilder.create().uv(12, 41).cuboid(-2.0F, -1.0F, -1.0F, 3.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-2.0F, 0.0F, 1.0F, 0.0F, 1.0472F, 0.3054F));

		ModelPartData apex_4 = leaf_4.addChild("apex_4", ModelPartBuilder.create(), ModelTransform.pivot(-5.0F, 0.0F, 7.0F));

		ModelPartData cube_r17 = apex_4.addChild("cube_r17", ModelPartBuilder.create().uv(0, 41).cuboid(-2.0F, -1.0F, -2.0F, 3.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.3142F, 1.0042F, 0.3656F));
